...
&НаКлиенте
Процедура кс_ДобавитьСОтбором(Команда)
	
	Если ТипОбъектовДляВыгрузки.Типы().Количество() = 1 Тогда
		
		ПараметрыПодбора = Новый Структура;
		ПараметрыПодбора.Вставить( "ИмяТаблицы", ТипОбъектовДляВыгрузки.Типы()[0] );
		ПараметрыПодбора.Вставить( "ДействиеВыбора", Истина );
		
		ОткрытьФорму("ВнешняяОбработка.ВыгрузкаЗагрузкаДанныхXML.Форма.кс_ВыборОбъектовОтбором", ПараметрыПодбора, ЭтотОбъект);
...
Процедура ОбработкаВыбораНаСервере(ВыбранныеЗначения)
	...
	Если ТипЗнч(ВыбранныеЗначения) = Тип("Структура") Тогда
		...
		// {{кс_СТАНДАРТ СК 2020.06.08
		Если ТипЗнч(ВыбранныеЗначения.ДанныеВыбора) = Тип("Массив") Тогда
			ВыбранныеСсылки = ВыбранныеЗначения.ДанныеВыбора;
		Иначе
		// }}кс_СТАНДАРТ СК 2020.06.08
